module.exports = {
    ...
    baseUrl: '/standard-assets/',
    organizationName: 'terascope',
    projectName: 'standard-assets',
    scripts: [
        'https://buttons.github.io/buttons.js',
        'https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.0/clipboard.min.js',
        '/standard-assets/js/copy-code-block.js'
    ],
    stylesheets: [
        {
            href: '/standard-assets/css/custom.css',
            type: 'text/css',
            rel: 'stylesheet'
        }
    ],
    ...
    themeConfig: {
        ...
        navbar: {
            ...
            items: [
                ...
                {
                    href: 'https://github.com/terascope/standard-assets',
                    label: 'GitHub',
                    position: 'left'
                },
                {
            ...
            links: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: 'Github',
                            to: 'https://github.com/terascope/standard-assets',
                        },
                        {
